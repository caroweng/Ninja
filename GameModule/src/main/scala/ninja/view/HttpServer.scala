...
import ninja.model.component.component.component.CellInterface
...
class HttpServer(controller: ControllerInterface) {
    ...
    val bindingFuture = Http().bindAndHandle(concat(ninjaRoute, startMenuRoute, startRoute, stateRoute), "localhost", 8080)
